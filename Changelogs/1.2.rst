========================
Azam sharif Bot Version Update
========================
...
* **Updated  azamBot Startup & Core.**

+------------------------------------------------------------------------------------------------------------------------------------------+
| Now azamBot supports multi clients at it's fullest. Will add more database based command in multi clients soon with updates. Stay tuned! |
+------------------------------------------------------------------------------------------------------------------------------------------+
...
:owner: * ` <https://t.me/azam_sharif_owner

By ~ `AZAMẞø† Network { 🇮🇳 } <https://t.me/azam_sharif_gorup>`_
=================================================
